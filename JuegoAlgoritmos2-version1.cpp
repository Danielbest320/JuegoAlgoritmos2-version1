...
void reglasdejuego3() {
    ...
    cout << "En este juego te vamos a dar la descripción de los personajes y tú tienes que adivinar el personaje correcto" << endl << endl;
    cout << "Tendrás 10 oportunidades por turno. Cada respuesta correcta suma 10 puntos, y por cada incorrecta se restan 5 puntos." << endl;

    cout << "Además, tienes comodines que puedes usar para obtener una respuesta correcta automáticamente, pero ten cuidado, solo tienes unos pocos!" << endl;
...
void juego3Adivinarpalabra(Jugador& jugador) {
    ...
    for (const auto& pregunta : preguntas) {
        ...
        // Mostrar pista si está disponible y no ha sido usada
        ...
        if (respuesta == "comodin" && comodines > 0) {
            cout << "¡Has usado un comodín! La respuesta correcta es: " << pregunta.second << endl;
